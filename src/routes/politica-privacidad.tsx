...
export const Route = createFileRoute("/politica-privacidad")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://mipuebloencyl.es/politica-privacidad" },
      ...
      { name: "twitter:title", content: "Política de privacidad | MiPuebloEnCyL" },
      { name: "twitter:description", content: "Tratamiento de datos personales en MiPuebloEnCyL." },
      { name: "twitter:image", content: "https://mipuebloencyl.es/og-mipuebloencyl.jpg" },
    ],
    links: [{ rel: "canonical", href: "https://mipuebloencyl.es/politica-privacidad" }],
  }),
