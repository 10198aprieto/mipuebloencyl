...
export const Route = createFileRoute("/politica-cookies")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://mipuebloencyl.es/politica-cookies" },
      ...
      { name: "twitter:title", content: "Política de cookies | MiPuebloEnCyL" },
      { name: "twitter:description", content: "Cookies utilizadas en MiPuebloEnCyL y cómo gestionarlas." },
      { name: "twitter:image", content: "https://mipuebloencyl.es/og-mipuebloencyl.jpg" },
    ],
    links: [{ rel: "canonical", href: "https://mipuebloencyl.es/politica-cookies" }],
  }),
  component: Cookies,
});
